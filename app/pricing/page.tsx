      ...
      <main className="flex-1">
        <section className="bg-[#006B3F] text-white px-4 py-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mt-6">
            <Link href="/list-business" className="bg-white text-[#006B3F] font-semibold px-6 py-3 rounded-2xl">List free</Link>
            <a href={WA} target="_blank" rel="noopener noreferrer" className="bg-[#004d2e] border border-white/30 text-white font-semibold px-6 py-3 rounded-2xl">WhatsApp us</a>
          </div>
        </section>
        <section className="px-4 py-10">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 xl:grid-cols-4 gap-4">
            <div className="bg-white border rounded-2xl p-6 flex flex-col">
              ...
              <Link href="/list-business" className="text-center bg-[#006B3F] text-white font-semibold py-3 rounded-xl">Start free</Link>
            </div>
            <div className="bg-white border rounded-2xl p-6 flex flex-col">
              ...
              <a href={WA} target="_blank" rel="noopener noreferrer" className="text-center border border-[#006B3F] text-[#006B3F] font-semibold py-3 rounded-xl">Send photos</a>
            </div>
            <div className="bg-white border-2 border-[#006B3F] rounded-2xl p-6 flex flex-col shadow-sm">
              ...
              <a href={WA} target="_blank" rel="noopener noreferrer" className="text-center bg-[#006B3F] text-white font-semibold py-3 rounded-xl">Get Featured</a>
            </div>
            <div className="bg-white border rounded-2xl p-6 flex flex-col">
              ...
              <a href={WA} target="_blank" rel="noopener noreferrer" className="text-center border border-gray-300 font-semibold py-3 rounded-xl">Add video</a>
            </div>
          </div>
        </section>
